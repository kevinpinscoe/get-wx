...
| Version | Supported |
|---|---|
| latest `v1.0.x` release | yes |
| anything older | no |

## Reporting a vulnerability

Report privately through GitHub's
[security advisories](https://github.com/kevinpinscoe/get-wx/security/advisories/new)
...
cosign verify-blob \
  ...
  --certificate-identity-regexp \
    'https://github.com/kevinpinscoe/get-wx/.github/workflows/release.yml@refs/tags/v.*' \
